...
<head>
<title>Home</title>
<link href="${ctxCss}/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="${ctxJs}/jquery.min.js"></script>
<!-- Custom Theme files -->
<!--theme-style-->
<link href="${ctxCss}/style.css" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
...
<!--//fonts-->
<script src="${ctxJs}/jquery.easydropdown.js"></script>
	...
	<div class="header">
		<div class="container">
			<div class="header-top">			
				<div class="logo">
					<a href="index.html"><img src="${ctxImage}/logo.png" alt=" " ></a>
				</div>
				<div class="search-in">
